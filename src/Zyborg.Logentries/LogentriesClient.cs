...
namespace Zyborg.Logentries
{
    public class LogentriesClient
    {
        ...
        public LogentriesClient(bool useHttpPut, bool useSsl, bool useDataHub, String serverAddr, int port)
        {
        ...
        public void Connect()
        {
            ...
            m_Client.ConnectAsync(m_ServerAddr, m_TcpPort).Wait();
            ...
            if (m_UseSsl)
            {
                ...
                m_SslStream.AuthenticateAsClientAsync(m_ServerAddr).Wait();
            }
        }
